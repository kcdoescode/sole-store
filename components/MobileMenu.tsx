...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 z-[110] h-[100dvh] w-full max-w-xs bg-white shadow-2xl transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
